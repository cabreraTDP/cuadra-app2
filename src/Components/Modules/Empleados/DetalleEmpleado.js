  ...
  useEffect(() => {
    const getDatos = async (id) => {
      ...
      setDatos({
        ...
        numeroExterior:
          datosDelTrabajador.datosPersonales.direccion.numeroExterior,
        numeroInterior:
          datosDelTrabajador.datosPersonales.direccion.numeroInterior,
      ...
      setArchivos(
        datosDelTrabajador.documentos.length > 0
